                ...
                <div className="row">
                    <div className="col-lg-3">
                        <div>
                            ...
                            <img src="../../Teen.png" style={{ width: '100px' }} alt="Teen" />
                        }
                        {game.esrb_rating && game.esrb_rating.id === 4 &&
                            <img src="../../Mature.png" style={{ width: '100px' }} alt="Mature" />
                        }
                        {game.esrb_rating && game.esrb_rating.id === 5 &&
                            <img src="../../AdultsOnly.webp" style={{ width: '100px' }} alt="Adults Only" />
                        }
                        {game.esrb_rating && game.esrb_rating.id === 6 &&
                            <img src="../../Pending.png" style={{ width: '100px' }} alt="Pending" />
                        }
                        {game.esrb_rating == null &&
                            <img src="../../Everyone.png" style={{ width: '100px' }} alt="Everyone" />
                        }
                        </div>
                        <div className="my-4">
